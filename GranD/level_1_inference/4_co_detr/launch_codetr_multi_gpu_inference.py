...
def launch_codetr(image_names_txt_path, gpu_id, image_dir_path, output_dir_path, ckpt_path):
...
def main():
    ...
    for i, gpu_id in enumerate(gpu_ids):
        ...
        p = Process(target=launch_codetr, args=(txt_path, gpu_id, args.image_dir_path, args.output_dir_path,
                                                args.ckpt_path))
        processes.append(p)
        p.start()
